...
@Log4j2
@Tag(name = "Order Item Management", description = "APIs for managing order items in the bookstore")
public class OrderItemController extends AbstractResponseController {
    ...
    public ResponseEntity<OrderItemResponse> getById(@PathVariable final UUID id) {
        ...
        return ResponseEntity.ok(orderItemResponseMapper.toResponse(orderItem));
    }
